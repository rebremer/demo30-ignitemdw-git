Extented git repo of session "demo30: Transforming and enriching data" of the Microsoft Ingnite Data track. Git repo can be linked to ADFv2 to load the pipeline and to setup CI/CD in Azure DevOps.
